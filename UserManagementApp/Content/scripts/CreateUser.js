...
document.getElementById("SubmitButton").addEventListener("click",e=>CreateUser());
...
function CreateUser() {
    ...
    fetch("http://localhost:63694/Home/CreateUser", Parameters).then((response) => {
...
function ShowNotice() {
    localStorage.setItem("innerText", "User successfully created");
